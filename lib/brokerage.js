...
Brokerage.prototype.__updateInjectedComponent = function(changedComponent, whatChanged) {
  ...
  let updatedElement = this.constructBrokeredElement(changedComponent.component.name, whatChanged.description, newAPI, whatChanged.url, true);
...
Brokerage.prototype.constructBrokeredElement = function(brokeredComponentName, model, $happn, url, dynamic){
  return {
    module: {
...
Brokerage.prototype.injectBrokeredComponent = function(model) {
  let elementsToConstruct = Object.keys(model.package)
    .map((brokeredComponentName) => {
      let elementToInject = this.constructBrokeredElement(brokeredComponentName, model.package[brokeredComponentName], model.$happn, this.__mesh);
