    ...
    return {
      ...
      start: function(callback) {
        ...
        if (Object.keys(brokeredModels).length > 0) {
          _this.broker = require('./broker-component').create(brokeredModels, mesh, client);
          return _this.broker.inject(callback);
        }
      ...
      stop: function(callback) {
        client.unmount();
        client = undefined;
        if (this.broker) return this.broker.detach(callback);
        callback();
      }
    }
  }
